...
jQuery(document).ready(function($) {
	...
	$('body').fitVids();
	$('.col-md-3').addClass('col-sm-6');
	$('.video-slider, .rev_slider_wrapper').parents('#content').parent().find('header').removeClass('header-bg');
	$('#section-contact').find('.col-md-8').attr('data-animation','fadeInLeft').addClass('animated');
	$('#section-contact').find('.col-md-4').attr('data-animation','fadeInRight').addClass('animated');
// --------------------------------------------------
// paralax background
// --------------------------------------------------
...
// --------------------------------------------------
	...
	jQuery(".de-team-list").hover(function() {
		 ...
		 jQuery(this).find(".team-desc").stop(true).animate({'top': "0px"},450,'easeOutQuad');
		 jQuery(this).find("img").stop(true).animate({'margin-top': "-100px"},500,'easeOutQuad');
	},
    function() {
		 jQuery(this).find(".team-desc").stop(true).animate({'top': h},450,'easeOutQuad');
		 jQuery(this).find("img").stop(true).animate({'margin-top': "0px"},500,'easeOutQuad');
  	})
	...
	// portfolio
		...
		jQuery('.item .pic-frame').each(function(){	
...
// --------------------------------------------------
	...
	//jQuery('#section-slider').next().css("margin-top", $doc_height);
...
// one page navigation
        ...
        jQuery("#homepage nav a, .btn").click(function(evn){
