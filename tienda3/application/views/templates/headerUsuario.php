<?php
//***************************************************************************************
//Esta vista es la cabecera de las paginas web en este caso el de usuario el cual no 
//tiene el link de admin. Es total mente responsive y cambia de color de acuerdo al tema.
//Autor: Akzel Novoa
    ...
    <nav  class="justify-content-start align-items-center navbar navbar-expand-lg navbar-light navbar-fixed-top col-md-12 mechescolors navbar-dark">
        ...
        <div  class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0">
                <a class="btn btn-default mechesheader linksmechesheader" href="userLogout"><i class="fa fa-sign-out" style="font-size:30px; margin-right: 10px;"></i></a>
