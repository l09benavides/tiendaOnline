<?php
//************************************************************************************
/*Este controlador forma parte del módulo de Bienvenida, contiene los métodos que permiten acceso a la vista relacionada con la página de bienvenida administrador, permite además comunicación y transferencia de información con los modelos que tienen acceso a la BD, se comunica con los siguientes archivos:
-Model_Imagen.php
...
class Ctrl_bienvenidaAdmin extends CI_Controller {
	...
	public function __construct()
        {
        	...
        	}else{redirect('Ctrl_bienvenida','refresh');}
        }
