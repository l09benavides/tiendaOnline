...
//transacciones aprobadas previamiente por el administrador del sistema.
//Dentro del panel aparecen todas las transacciones aprobadas del usuario.  
...
<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active">Transacciones Aprobadas</li>
</ol>

<div class="container-fluid">

	<h2 style="text-align: center;">Transacciones Aprobadas</h2>
	
	<div class="row no-gutters imagebuffer">
		<div class="col-sm-12 "></div>
	</div>

	<!--Tabla para mostrar todas las transacciones aprobadas para el usuario-->
			...
			<div id="listaAprobaciones">
				<table class="table table-striped table-bordered" id="Transacciones">
					...
					<tbody>
						...
						<tr>
							<!--foreach para llenar la tabla con la info de transacciones aprobadas en el sistema-->
							...
							<td style="vertical-align:middle;text-align:center;"> <?php echo form_open("Ctrl_transaccionesUsuarios/met_facturaUsuario");?>
								<input hidden id="IdTransaccion" name="IdTransaccion" value = "<?php echo $datosTransac['Transaccion'];?>">
								<!--Botón para ver la información de la factura asociada con la transacción-->
								<button type = "submit" class="btn btn-outline-success" id="verFactura" data-user="Factura" name="<?php echo $datosTransac['Transaccion']; ?>"><i  style="font-size:20px;" data-toggle="tooltipMod" title="Ver Factura"></i> Ver Factura</button>
							</form>
							</td>
						</tr>
	...
	<div class="row no-gutters direccionesbuffer">
		<div class="col-sm-12 ">
			...
			<!--DIV para MODAL de mostrar todos los detalles de la transacción-->
			...
			<!--Sección de modales para confirmación de datos-->
...
<script type="text/javascript">
	...
	//cargar los dato en el body del table
