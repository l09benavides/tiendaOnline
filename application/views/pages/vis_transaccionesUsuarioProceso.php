...
//transacciones en proceso que no han sido aprobadas o rechazadas todavía.
//Dentro del panel aparecen todas las transacciones en proceso del usuario.  
...
<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active">Transacciones en Proceso</li>
</ol>

<div class="container-fluid">

	<h2 style="text-align: center;">Transacciones en Proceso</h2>
	
	<div class="row no-gutters imagebuffer">
		<div class="col-sm-12 "></div>
	</div>
	
	<!--Tabla para mostrar todas las transacciones en proceso para el usuario-->
			...
			<div id="listaAprobaciones">
				<table class="table table-striped table-bordered" id="Transacciones">
					...
					<tbody>
						...
						<tr>
							<!--foreach para llenar la tabla con la info de transacciones en proceso en el sistema-->
