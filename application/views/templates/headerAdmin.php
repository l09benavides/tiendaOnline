...
<?php
//***************************************************************************************
//Esta vista es la cabecera de las paginas web en este caso el de Admin el cual  
//cuenta con el link de admin. Es total mente responsive y cambia de color de acuerdo al tema.
//Autor: Akzel Novoa
...
<!-- Polyfill Script para simular un input type=number en los browsers que no lo soportan -->
<script type="text/javascript" src="<?php echo base_url();?>assets/js/number-polyfill.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/css/number-polyfill.css" />

<script>//Es un script que corre el ajax de el search
  (function() {
...
<!-- Este script agarra los datos de la sesion del usuario-->
<?php
    ...
    <nav  class="justify-content-start align-items-center navbar navbar-expand-lg navbar-light navbar-fixed-top col-md-12 mechescolors navbar-dark">
        ...
        <div  class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="adminPanel">Administración</a>
                </li>


            </ul>
            <form class="form-inline my-2 my-lg-0">
                <a class="btn btn-default mechesheader linksmechesheader" href="adminLogout"><i class="fa fa-sign-out" style="font-size:30px; margin-right: 10px;"></i></a>
                <a class="btn btn-default mechesheader linksmechesheader " href="userProfile"><h6 class="h6meches" style="margin-right: 10px;"><?php echo $infoUser;?></h6></a>
                <a id="iconoCarrito" href="carrito" class="btn btn-default mechesheader linksmechesheader"> <span class="fa fa-shopping-cart" style="font-size: 30px;  margin-right: 10px;"></span><span class="badge badge-notify"><?php if(isset($session_data['carrito'])) {echo $session_data['carrito'];}?></span></a>
                    ...
                    <!-- Termina el codigo de html del header -->
